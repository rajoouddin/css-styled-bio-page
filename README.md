...
This activity involves using css to style the html bio page to look like the provided example.

I have used my current knowledge to get things to be as like the example as possible, but there is likely that improvements can be made.
